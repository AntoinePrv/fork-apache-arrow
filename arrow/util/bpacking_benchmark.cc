...
BENCHMARK_CAPTURE(BM_UnpackBool, Sse42ScalarBatch, &bpacking::unpack_sse4_2_scalar_batch<bool>)
    ->ArgsProduct(kBitWidthsNumValuesBool);
BENCHMARK_CAPTURE(BM_UnpackUint8, Sse42ScalarBatch, &bpacking::unpack_sse4_2_scalar_batch<uint8_t>)
    ->ArgsProduct(kBitWidthsNumValues8);
...
BENCHMARK_CAPTURE(BM_UnpackBool, Avx2ScalarBatch, &bpacking::unpack_avx2_scalar_batch<bool>,
                  !CpuInfo::GetInstance()->IsSupported(CpuInfo::AVX2),
                  "Avx2 not available")
    ->ArgsProduct(kBitWidthsNumValuesBool);
BENCHMARK_CAPTURE(BM_UnpackUint8, Avx2ScalarBatch, &bpacking::unpack_avx2_scalar_batch<uint8_t>,
                  !CpuInfo::GetInstance()->IsSupported(CpuInfo::AVX2),
                  "Avx2 not available")
    ->ArgsProduct(kBitWidthsNumValues8);
...
BENCHMARK_CAPTURE(BM_UnpackBool, NeonScalarBatch, &bpacking::unpack_neon_scalar_batch<bool>)
    ->ArgsProduct(kBitWidthsNumValuesBool);
BENCHMARK_CAPTURE(BM_UnpackUint8, NeonScalarBatch, &bpacking::unpack_neon_scalar_batch<uint8_t>)
    ->ArgsProduct(kBitWidthsNumValues8);
BENCHMARK_CAPTURE(BM_UnpackUint16, NeonScalarBatch, &bpacking::unpack_neon_scalar_batch<uint16_t>)
    ->ArgsProduct(kBitWidthsNumValues16);
BENCHMARK_CAPTURE(BM_UnpackUint32, NeonScalarBatch, &bpacking::unpack_neon_scalar_batch<uint32_t>)
    ->ArgsProduct(kBitWidthsNumValues32);
BENCHMARK_CAPTURE(BM_UnpackUint64, NeonScalarBatch, &bpacking::unpack_neon_scalar_batch<uint64_t>)
    ->ArgsProduct(kBitWidthsNumValues64);
